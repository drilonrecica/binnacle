...
{:else}
  <div class="shell">
    ...
    <main id="content">
      ...
      {#if route === 'overview'}<Overview {live} />{:else if route === 'resources'}<Resources {live} />{:else if route === 'server'}<Server {live} />{:else if route === 'events'}<Events {live} />{:else if route === 'checks'}<p>
