...
| v0.2 checks and alerts | Implemented; release qualification pending, tag not published | HTTP/HTTPS checks, deterministic local alerts, timed silences, deployment grace, and effective resource health. |
| v0.3 notifications and incident grouping | Planned | Outbound notification delivery and grouping related alerts into incidents. |
| v0.4 diagnostics | Planned | Bounded log access and read-only process diagnostics. |
