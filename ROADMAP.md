...
| v0.3 notifications and incident grouping | Implemented; release qualification pending | Durable HTTPS webhook and SMTP delivery with automatic target-based incidents. |
